...
public class FirstController : MonoBehaviour, ISceneController, IUserAction{
    ...
    public void MoveBoat() {
        ...
        boatCtrl.boatAction.boatMove(boatCtrl);
    ...
    public void CharacterClicked(MyNamespace.CharacterController characterCtrl) {
        if (characterCtrl.character.IsOnBoat) {
            ...
            boatCtrl.boatAction.GetOffBoat(characterCtrl.character.Name, boatCtrl);
            characterCtrl.MoveTo(tempCoast.GetEmptyPosition());
            characterCtrl.myAction.GetOnCoast(characterCtrl,tempCoast);
            //tempCoast.GetOnCoast(characterCtrl, tempCoast);
            ...
            tempCoast.coastAction.GetOffCoast(characterCtrl.character.Name, tempCoast);
            characterCtrl.MoveTo(boatCtrl.GetEmptyPosition());
            //characterCtrl.GetOnBoat(boatCtrl);
            boatCtrl.boatAction.GetOnBoat(characterCtrl,boatCtrl);
