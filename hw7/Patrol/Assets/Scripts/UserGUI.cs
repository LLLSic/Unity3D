...
public class UserGUI : MonoBehaviour {
    ...
    void Start ()
    {
        ...
        text_style.normal.textColor = new Color(0, 0.92f,0.016f,1);
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(Screen.width - 170, 5, 50, 50), "剩余面包数:", text_style);
        ...
        if(show_time > 0)
        {
            ...
            GUI.Label(new Rect(Screen.width / 2 - 90, 50, 100, 100), "采集完所有的面包即可获胜", text_style);
        }
    }
